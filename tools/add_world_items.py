...
NEW_ITEMS = [
    ...
    # ---- mario (Partners in Time sheet) ----
    dict(id="ultra_mushroom", name="Ultra Mushroom", world="mario", category="consumable", price=450,
         tags=["mushroom", "powerup", "rare"], desc="A green-capped mushroom for serious growth spurts."),
    dict(id="refreshing_herb", name="Refreshing Herb", world="mario", category="consumable", price=180,
         tags=["plant", "healing", "cure"], desc="A minty four-leaf herb that clears any ailment, including embarrassment."),
    dict(id="red_pepper", name="Red Pepper", world="mario", category="food", price=220,
         tags=["food", "spicy", "buff"], desc="Devilishly hot. Boosts power and ruins conversation."),
    dict(id="green_pepper", name="Green Pepper", world="mario", category="food", price=220,
         tags=["food", "spicy", "buff"], desc="A crisp pepper that toughens the eater's hide."),
    dict(id="blue_pepper", name="Blue Pepper", world="mario", category="food", price=220,
         tags=["food", "spicy", "buff"], desc="An impossibly blue pepper. Eat it and try to stand still."),
    dict(id="red_koopa_shell", name="Red Koopa Shell", world="mario", category="material", price=280,
         tags=["shell", "projectile", "rare"], desc="A red shell that never misses. The green ones are jealous."),
    dict(id="smash_egg", name="Smash Egg", world="mario", category="consumable", price=320,
         tags=["egg", "weird"], desc="Crack it over something's head. There is always a prize inside."),
    dict(id="copy_flower", name="Copy Flower", world="mario", category="consumable", price=600,
         tags=["powerup", "plant", "rare"], desc="Split into a crowd of yourself and pile on."),
    dict(id="mix_flower", name="Mix Flower", world="mario", category="consumable", price=550,
         tags=["powerup", "plant", "rare"], desc="A two-headed flower that pools everyone's fire into one blast."),
    # ---- naruto ----
