-- KH CoM: COLD BOOT on the user's converted completed save — NO savestates,
-- NO scripted input. The user takes over from the title screen and loads
-- File 1 themselves. Records OAM/OBJ-VRAM/OBJ-PAL on OAM-change frames +
-- ref screenshots to out/oam_kh_live/ for REC_MINUTES; live_view.png
-- refreshes every second. Emulator stays open when recording ends.
...
gui.addmessage("== YOUR CONTROLS from boot — load File 1 yourself ==")
