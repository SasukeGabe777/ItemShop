...
const HELP_TOPICS := {
	...
	"Purse": "Purse is a broad hint—Very light, Light, Good, or Heavy—not an exact safe price. It reflects the customer's buying power for that item, including personality, mood, preferences, your Bond, and shop bonuses. Use their counteroffers to read the rest.",
